...
export const BOOKS = [
  ...
  { id:4, title:"Blue Team Handbook — CyberHawk UG", author:"CyberHawk UG", year:2023, cat:"Blue Team", desc:"Concise reference guide for incident responders covering detection, analysis, and response procedures with practical checklists.", pages:204, icon:"🛡️", cover: U("photo-1563206767-5b18f218e8de") },
  { id:5, title:"Threat Intelligence and Me — CyberHawk UG", author:"CyberHawk UG", year:2024, cat:"Threat Intel", desc:"A practical guide to building and operationalizing a threat intelligence program from the ground up in any organization size.", pages:320, icon:"📡", cover: U("photo-1504384308090-c894fdcc538d") },
  { id:6, title:"Zero Trust Networks — CyberHawk UG", author:"CyberHawk UG", year:2023, cat:"Architecture", desc:"Building secure systems in untrusted networks. Covers the design principles, protocols, and implementation strategies for ZTA.", pages:240, icon:"🏗️", cover: U("photo-1558494949-ef010cbdcc31") },
  ...
  { id:9, title:"Building & Using AI Agents to Make Money — CyberHawk UG", author:"CyberHawk UG", year:2026, cat:"AI & Automation", desc:"A practical playbook for designing, deploying, and monetizing AI agents using Lovable, Cursor, GitHub, Vercel, Supabase, and Stripe — with real workflows for TikTok payouts, e-commerce, and crypto rails.", pages:228, icon:"🤖", priceUSD: 15, priceUGX: 55000, isPaid: true },
  { id:11, title:"Python Programming for Security Professionals — CyberHawk UG", author:"CyberHawk UG", year:2026, cat:"Programming", desc:"A comprehensive guide to mastering Python for cybersecurity, covering automation, networking, OSINT, and AI-driven defense mechanisms.", pages:105, icon:"🐍", priceUSD: 10, priceUGX: 37000, isPaid: true },
];
