...
export const BOOKS = [
  ...
  { id:2, title:"Hacking: The Art of Exploitation — CyberHawk UG", author:"CyberHawk UG", year:2022, cat:"Technical", desc:"A deep dive into the technical aspects of exploits, shellcode, network attacks, and cryptographic weaknesses with hands-on examples.", pages:488, icon:"💻", cover: U("photo-1555949963-aa79dcee981c"), isFree: true },
  { id:3, title:"The Web Application Hacker's Handbook — CyberHawk UG", author:"CyberHawk UG", year:2024, cat:"Web Security", desc:"The definitive guide to finding and exploiting web application security flaws, covering OWASP Top 10 and beyond.", pages:912, icon:"🌐", cover: U("photo-1451187580459-43490279c0fa"), isFree: true },
  { id:4, title:"Blue Team Handbook — CyberHawk UG", author:"CyberHawk UG", year:2023, cat:"Blue Team", desc:"Concise reference guide for incident responders covering detection, analysis, and response procedures with practical checklists.", pages:204, icon:"🛡️", cover: U("photo-1563206767-5b18f218e8de"), isFree: true },
  { id:5, title:"Threat Intelligence and Me — CyberHawk UG", author:"CyberHawk UG", year:2024, cat:"Threat Intel", desc:"A practical guide to building and operationalizing a threat intelligence program from the ground up in any organization size.", pages:320, icon:"📡", cover: U("photo-1504384308090-c894fdcc538d"), isFree: true },
  { id:6, title:"Zero Trust Networks — CyberHawk UG", author:"CyberHawk UG", year:2023, cat:"Architecture", desc:"Building secure systems in untrusted networks. Covers the design principles, protocols, and implementation strategies for ZTA.", pages:240, icon:"🏗️", cover: U("photo-1558494949-ef010cbdcc31"), isFree: true },
  { id:7, title:"Practical Malware Analysis — CyberHawk UG", author:"CyberHawk UG", year:2022, cat:"Malware", desc:"The hands-on guide to dissecting malicious software. Learn the tools, techniques, and processes used by professional malware analysts.", pages:800, icon:"🦠", cover: U("photo-1526374965328-7f61d4dc18c5"), isFree: true },
  { id:8, title:"Social Engineering: The Science of Human Hacking — CyberHawk UG", author:"CyberHawk UG", year:2023, cat:"Social Engineering", desc:"Understanding the psychological principles behind manipulation and how to build human-centered security awareness programs.", pages:320, icon:"🎭", cover: U("photo-1521737604893-d14cc237f11d"), isFree: true },
  ...
  { id:11, title:"Python Programming for Security Professionals — CyberHawk UG", author:"CyberHawk UG", year:2026, cat:"Programming", desc:"A comprehensive guide to mastering Python for cybersecurity, covering automation, networking, OSINT, and AI-driven defense mechanisms.", pages:105, icon:"🐍", cover: U("photo-1629654297299-c8506221ca97"), isFree: true },
  { id:12, title:"Advanced Ethical Hacking 2026 — CyberHawk UG", author:"CyberHawk UG", year:2026, cat:"Offensive Security", desc:"The ultimate playbook for offensive security in an AI-driven world. Master reconnaissance, cloud exploitation, and persistence techniques.", pages:200, icon:"🔓", cover: U("photo-1550751827-4bd374c3f58b"), isFree: true },
  { id:13, title:"Cybersecurity Strategies 2026 — CyberHawk UG", author:"CyberHawk UG", year:2026, cat:"Architecture", desc:"A comprehensive guide to building resilient digital infrastructures using Zero Trust, AI-driven SOC, and cloud-native security.", pages:200, icon:"🛡️", cover: U("photo-1563013544-824ae1b704d3"), isFree: true },
  { id:14, title:"Networking: Foundations to Advanced Architecture — CyberHawk UG", author:"CyberHawk UG", year:2026, cat:"Technical", desc:"The definitive 2026 guide to networking. Covers everything from bits and IP addresses to SDN, 5G, and quantum links for beginners and pros.", pages:200, icon:"🌐", cover: U("photo-1451187580459-43490279c0fa"), isFree: true },
];
