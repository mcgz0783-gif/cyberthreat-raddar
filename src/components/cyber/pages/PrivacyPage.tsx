    ...
    <section className="container mx-auto px-6 py-14 max-w-4xl">
      ...
      <div className="card-cyber p-8 space-y-6 text-foreground/85 text-[15px] leading-relaxed">
        <div>
          ...
          <p>CyberHawk UG ("we", "us") collects only what is needed to deliver the platform: email addresses for newsletter subscribers, messages submitted via the contact form, and anonymized analytics (page views, device class, country) through privacy-respecting tools.</p>
        </div>
        <div>
